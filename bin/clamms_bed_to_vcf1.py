            ...
            for sample_id in mutations_by_sample:
                ...
                for mutation in mutations:
                    try:
                        ...
                        # Write the VCF entry
                        vcf_file.write(f"{chrom}\t{start}\t.\tN\t<{cnv_type}>\t.\t{filter_status}\tEND={end};SVLEN={svlen};CN={mlcn};SVMETHOD=CLAMMS;SVTYPE={svtype};CIPOS={ci_pos};STRANDS={strands}\tGT:Q_SOME:Q_EXACT")
